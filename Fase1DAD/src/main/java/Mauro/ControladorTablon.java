...
public class ControladorTablon{
		...
		public String agregarValoracion(Model model, @PathVariable long id, Valoracion valoracion, Usuario usuario){
			Usuario usuarioEncontrado = repositorioUsuarios.findOne(usuario.getId());
